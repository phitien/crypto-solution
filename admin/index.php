<?php
define('APP', 'sozomvp');
define('APP_TYPE', 'html');
define('APP_NAME', 'SOZO - MVP');
...
define('EXTERNAL_URL','http://api.szo.io');
define('EXTERNAL_EMAIL_VERIFICATION',EXTERNAL_URL.'/email/verification');
define('EXTERNAL_PASSWORD_FORGET',EXTERNAL_URL.'/password/forget');
define('EXTERNAL_PASSWORD_RESET',EXTERNAL_URL.'/password/reset');
