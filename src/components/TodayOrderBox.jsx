...
class TodayOrderBox extends Component {
  get cmpClassName() {return `box today-order ${this.negative ? 'negative' : 'positive'}`}
  ...
  renderChildren() {
    return [
      <div className='box-title' dangerouslySetInnerHTML={{__html: `Today's Order`}}/>,
